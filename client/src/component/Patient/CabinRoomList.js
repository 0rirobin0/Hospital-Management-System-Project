    ...
    <div className="overflow-auto flex-grow">
      <table className="w-full bg-white table-fixed border-collapse border border-black">
        <thead className="bg-gray-700 text-center text-black sticky top-0">
          <tr>
            <th className="px-4 py-2 text-start border border-black">Cabin Name</th>
            <th className="px-3 py-2 text-start border border-black">Room number</th>
            <th className="px-3 py-2 text-start border border-black">Assigned Nurse ID</th>
            <th className="px-3 py-2 text-start border border-black">Supervising Doctor ID</th>
